...
local menu = {
    ...
    miscTab = {
        ...
        gedfsgsd1fgn_lagdsfgdgdhghbel = label(fl_tab, "\v•\r \affc0cbffAddictional Hitchance"),
        gensdf1g_labeghghl_line = label(fl_tab, "\a464646CC¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯"),
        additional_hitchance = switch(other_tab, "\aF88BFFFF:3 ~ \aFFFFFFFFAdditional HitChance"),
        hitchance_states = list(other_tab, "\aF88BFFFF:3 ~ \aFFFFFFFFStates", {"Global", "Standing", "Running", "Moving", "Crouching", "Air", "Air+C", "Sneaking", "On FL", "On FS"}),
        hitchance_value = slider("AA", "Other", "\aF88BFFFF:3 ~ \aFFFFFFFFHitChance Value", 1, 100, 50, true, "%", 1),
    },
    extras = {
...
velours.config_data.cfg_data = {
    ...
    visuals = {
        ...
        menu.visualsTab.indicator_redesign;
...
if not ui.get(menu.miscTab.additional_hitchance) then 
...
local selected_states = ui.get(menu.miscTab.hitchance_states)

if func.table_contains(selected_states, current_state) then
    if not original_hitchance then
        original_hitchance = ui.get(refs.hitChance)
    end
    ui.set(refs.hitChance, ui.get(menu.miscTab.hitchance_value))
