    ...
    local menu = {
        aaTab = {
            ...
            legitAAHotkey = switch(aa_tab, "Legit AA"),
            ...
            edge_on_fd = switch(aa_tab, "Edge Yaw on FakeDuck"),
            safe_head = list(aa_tab, "Safe Head", {"Air Knife hold", "Air Zeus hold"}),
            safe_flick = switch(aa_tab, "Defensive Safe Head"),
            safe_flick_mode = combo(aa_tab, "Mode", {"Default", "Flick", "E spam"}),
    ...
    event_callback("paint_ui", function()
        ...
        ui.set_visible(menu.visualsTab.animates_left_down, ui.get(menu.visualsTab.snowball) and (isMiscTab and isEnabled))
        ui.set_visible(menu.visualsTab.snowflake_count, ui.get(menu.visualsTab.snowball) and (isMiscTab and isEnabled))
        ui.set_visible(menu.visualsTab.snowflake_speed, ui.get(menu.visualsTab.snowball) and (isMiscTab and isEnabled))
    ...
    vars.phrases = {
        ...
        '「✨ velours: rewriting the rules of engagement ✨」',
